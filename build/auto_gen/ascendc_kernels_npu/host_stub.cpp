...
struct ascend_kernels {
    ...
    uint8_t aiv_buf[288208];
} __ascend_kernel_ascend910b3_ascendc_kernels_npu __attribute__ ((section (".ascend.kernel.ascend910b3.ascendc_kernels_npu"))) = {1,1,1,288208,288208,{0}};
...
struct HammingTilingData {
    ...
    uint32_t reduceSumWorkSpaceSize = 1024;
