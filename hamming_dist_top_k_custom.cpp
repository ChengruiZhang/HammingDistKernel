...
template <typename dataType, uint32_t axis> class KernelHammingDistTopK;

// 针对axis = 0的场景
template <> class KernelHammingDistTopK<bfloat16_t, 0> {
public:
    __aicore__ inline KernelHammingDistTopK() {}
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, HammingTilingData tiling)
    {
...
template <> class KernelHammingDistTopK<int8_t, 0> {
public:
    __aicore__ inline KernelHammingDistTopK() {}
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, HammingTilingData tiling)
    {
...
template <typename dataType> class KernelHammingDistTopK<dataType, 0> {
public:
    __aicore__ inline KernelHammingDistTopK() {}
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, HammingTilingData tiling)
    {
...
// 针对axis = 1的场景
template <> class KernelHammingDistTopK<bfloat16_t, 1> {
public:
    __aicore__ inline KernelHammingDistTopK() {}
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, HammingTilingData tiling)
    {
...
template <> class KernelHammingDistTopK<int8_t, 1> {
public:
    __aicore__ inline KernelHammingDistTopK() {}
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, HammingTilingData tiling)
    {
...
template <typename dataType> class KernelHammingDistTopK<dataType, 1> {
public:
    __aicore__ inline KernelHammingDistTopK() {}
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, HammingTilingData tiling)
    {
        ...
        //     AscendC::GetBlockIdx(), tiling.blockLength); yGm.SetGlobalBuffer((__gm__ dataType
        //     *)shorterInputPtr + tiling.blockLength * AscendC::GetBlockIdx() / this->coef, tiling.blockLength
        //     / this->coef); zGm.SetGlobalBuffer((__gm__ dataType *)z + tiling.blockLength *
        ...
        //         AscendC::GetBlockIdx(), tiling.formerLength); yGm.SetGlobalBuffer((__gm__ dataType
        //         *)shorterInputPtr + tiling.formerLength * AscendC::GetBlockIdx() / this->coef,
        //         tiling.formerLength / this->coef); zGm.SetGlobalBuffer((__gm__ dataType *)z +
        //         tiling.formerLength * AscendC::GetBlockIdx(), tiling.formerLength);
        //     } else {
        //         this->tileNum = tiling.tailTileNum;
        //         this->tileLength = tiling.tailTileLength / BUFFER_NUM;
        //         this->lastTileLength = tiling.tailLastTileLength;
        ...
        //         tiling.formerNum / this->coef + tiling.tailLength * (AscendC::GetBlockIdx() -
        //         tiling.formerNum) / this->coef, tiling.tailLength / this->coef); zGm.SetGlobalBuffer((__gm__
        //         dataType *)z + tiling.formerLength * tiling.formerNum +
        //             tiling.tailLength * (AscendC::GetBlockIdx() - tiling.formerNum), tiling.tailLength);
        //     }
        // }
        // pipe.InitBuffer(inQueueX, BUFFER_NUM, this->tileLength * sizeof(dataType));
...
{
    // AscendC::PRINTF("L824");
    KernelHammingDistTopK<uint16_t, 0> op;
    ...
    //         KernelHammingDistTopK<bfloat16_t, 0> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_FLOAT16) {
    //         KernelHammingDistTopK<half, 0> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_FLOAT32) {
    //         KernelHammingDistTopK<float, 0> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_INT8) {
    //         KernelHammingDistTopK<int8_t, 0> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_INT16) {
    //         KernelHammingDistTopK<int16_t, 0> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_INT32) {
    //         KernelHammingDistTopK<int32_t, 0> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else {
    //         return;
    ...
    //     if (tiling.dataType == ADD_BFLOAT16) {
    //         KernelHammingDistTopK<bfloat16_t, 1> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_FLOAT16) {
    //         KernelHammingDistTopK<half, 1> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_FLOAT32) {
    //         KernelHammingDistTopK<float, 1> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_INT8) {
    //         KernelHammingDistTopK<int8_t, 1> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_INT16) {
    //         KernelHammingDistTopK<int16_t, 1> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else if (tiling.dataType == ADD_INT32) {
    //         KernelHammingDistTopK<int32_t, 1> op;
    //         op.Init(x, y, z, tiling);
    //         op.Process();
    //     } else {
    //         return;
