...
if __name__ == "__main__":
    ...
    qhash_packed = rng.integers(0, 128, size=(batchSize, 1, headQ, packD), dtype=np.uint8)
    khash_packed = rng.integers(0, 128, size=(batchSize, seqLen, headK, packD), dtype=np.uint8)
